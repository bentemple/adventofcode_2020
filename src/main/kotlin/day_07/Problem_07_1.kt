...
class Problem_07_1() : Solution {
    ...
    private fun countBagsContainingBagColors(
        targetBagColors: Set<String>,
        bagColorsMap: MutableMap<String, List<String>>
    ): Int {
        ...
        return remainingColorsToFind.size + countBagsContainingBagColors(
            bagsContainingATargetBagColor + targetBagColors,
            bagColorsMap
        )
    }
}
